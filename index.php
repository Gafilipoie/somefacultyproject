                                                ...
                                                <div class="loginForm">
                                                 <form name="login" action="register2.php" method="post" >
                                                   <div class="form1">
                                                        ...
                                                        Adress: <input type="text" name="h_address" style="margin-left: 28px;">
                                                        Contry: <input type="text" name="h_country" style="margin-left: 48px;">
                                                        City: <input type="text" name="h_city" style="margin-left: 44px;"><br>
                                                        Postal Code: <input type="text" name="h_postalCode" style="margin-left: 28px;">
                                                    </div>
                                                    <div class="form2">
                                                        Mobil: <input type="text" name="h_mobile" style="margin-left: 10px;"><br>
                                                        Phone: <input type="text" name="h_phone" style="margin-left: 24px;"><br>
                                                        Fax: <input type="text" name="h_fax"><br>
                                                        Username: <input type="date" name="h_username" style="margin-left: 12.1px;"><br>
                                                    </div>
                                                    <div class="form3">
                                                        Email: <input type="email" name="h_email" style="margin-left: 82px;">
                                                        Password: <input type="password" name="h_password" style="margin-left: 13px;">
                                                        Confirm Password: <input type="password" name="h_confirmPassword" style="margin-left: 0px;">
                                                        <input type="submit" value="Submit" style="float: right; width: 90px; height: 30px; font-weight: bold;"> 
                                                    </div>      
                                                 </form>
                                                </div>
